...
int main()
{
	...
	//Mat frame_final;
	Mat result;
	//TColorDetector::SetupColors([(130,140,130),(150,141,160)], (19,19,19))
	//std::vector<cv::Vec3b> colors[2][3]=[(130,140,130),(150,141,160)];
	std::vector<cv::Vec3b> colors(1);
	//colors[0]=cv::Vec3b(124,78,46);
	colors[0]=cv::Vec3b(24,204,255);
	//colors[1]=cv::Vec3b(30,40,20);
	//colors[2]=cv::Vec3b(13,20,11);
	//colors[3]=cv::Vec3b(50,13,30);
	
	cv::Vec3s col_radius=(2,5,3);
	//cv::Vec3s col_radius=(7,10,30);
	TColorDetector  obj;
	obj.SetupColors(colors, col_radius);
	...
	//{
		...
		//if (i==0)
		//{video>>frame_ori;
		//	result=frame_ori.clone();
		//	cout<<result.size()<<endl;
		//	imshow("frame", obj.Detect(frame_ori));
		//	}
		...
		imshow("result", obj.Detect(frame_ori));
